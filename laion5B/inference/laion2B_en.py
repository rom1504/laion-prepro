...
input_dataset = "pipe:aws s3 cp --quiet s3://laion-us-east-1/laion-data/laion2B-data/{000000..231349}.tar -"
clip_inference(
    input_dataset=input_dataset,
    output_folder="s3://laion-us-east-1/embeddings/vit-l-14/laion2B-en",
