...
index, index_infos = build_index(
    ...
    distributed="pyspark",
    max_index_memory_usage="400G",
    current_memory_available="24G",
    nb_indices_to_keep=40,
    file_format="npy",
    temporary_indices_folder="s3://laion-us-east-1/mytest/my_tmp_folder10",
    index_path="s3://laion-us-east-1/indices/vit-l-14/imagePQ64/knn.index",
    index_infos_path="s3://laion-us-east-1/indices/vit-l-14/imagePQ64/infos.json"
)
