...
index, index_infos = build_index(
    embeddings=["s3://laion-us-east-1/embeddings/vit-l-14/laion2B-multi/img_emb"],
    distributed="pyspark",
    max_index_memory_usage="300G",
    current_memory_available="26G",
    nb_indices_to_keep=40,
    file_format="npy",
    temporary_indices_folder="s3://laion-us-east-1/mytest/my_tmp_folder23",
    index_path="s3://laion-us-east-1/indices/vit-l-14/laion2B-multi-imagePQ128/knn.index",
    index_infos_path="s3://laion-us-east-1/indices/vit-l-14/laion2B-multi-imagePQ128/infos.json"
)
